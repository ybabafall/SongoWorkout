...
export default {
	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				// Échelle typographique Songo Workout - Standards modernes
			...
			colors: {
				...
				// Modern Fitness Color System - Ultra Light Ice Blue Theme
				'gold': {
				...
				'slate': {
					...
					steel: 'hsl(var(--steel-blue))', // Very light steel blue
				},
				'laboratory': {
					...
					700: 'hsl(210 25% 30%)', // Light charcoal
					800: 'hsl(210 20% 25%)',  // Deep tone
					900: 'hsl(210 25% 20%)',  // Dark tone
				},
			...
			backgroundImage: {
				// Modern Fitness Gradients - Ice Blue Theme
				...
				// Ultra Light Ice Blue UI gradients
