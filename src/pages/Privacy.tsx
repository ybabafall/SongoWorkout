            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-body-base text-neutral-700 max-w-3xl mx-auto leading-relaxed font-body">
                  Songo Workout accorde la plus grande importance à la protection de vos données personnelles et au respect de votre vie privée.
                </p>
              </div>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <p>
                      <strong>Songo Workout</strong><br />
                      SARL au capital de 50 000 €<br />
                      Paris, France<br />
                      Email : contact@songoworkout.fr<br />
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    <p>
                      Dans le cadre de nos services de coaching fitness, nous collectons les données suivantes :
                    </p>

                    <div>
                      <h3 className="text-heading-md font-display font-semibold text-neutral-900 mb-2 tracking-tight">Lors de l'inscription en ligne :</h3>
                      <ul className="list-disc list-inside space-y-2 ml-4">
                        <li>Civilité, nom et prénom</li>
                        <li>Adresse email</li>
                        <li>Numéro de téléphone</li>
                        <li>Adresse postale (pour les sessions à domicile)</li>
                        <li>Programme choisi et disponibilités</li>
                        <li>Informations sur vos objectifs fitness</li>
                      </ul>
                    </div>

                    <div>
                      <h3 className="text-heading-md font-display font-semibold text-neutral-900 mb-2 tracking-tight">Lors des sessions :</h3>
                      <ul className="list-disc list-inside space-y-2 ml-4">
                        <li>Évaluation physique (niveau, condition physique)</li>
                        <li>Historique sportif et objectifs</li>
                        <li>Problèmes de santé ou contre-indications éventuelles</li>
                        <li>Photographies de progression (uniquement avec votre consentement explicite)</li>
                      </ul>
                    </div>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li><strong>Gestion des inscriptions :</strong> Confirmation, modification ou annulation de votre abonnement</li>
                      <li><strong>Personnalisation du service :</strong> Adaptation du programme Songo Workout à vos objectifs spécifiques</li>
                      <li><strong>Traitement des paiements :</strong> Gestion des abonnements mensuels</li>
                      <li><strong>Communication :</strong> Rappels de sessions, confirmations, informations sur nos programmes</li>
                      <li><strong>Suivi sportif :</strong> Historique de progression pour optimiser les entraînements futurs</li>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li><strong>L'exécution d'un contrat :</strong> L'inscription et la réalisation de nos programmes de coaching</li>
                      <li><strong>Votre consentement :</strong> Pour les communications marketing et l'utilisation de photographies</li>
                      <li><strong>Notre intérêt légitime :</strong> Amélioration de nos services et personnalisation de l'expérience sportive</li>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li><strong>Données d'inscription :</strong> 3 ans après la fin de votre abonnement</li>
                      <li><strong>Historique sportif :</strong> 3 ans après votre dernière session (pour assurer la continuité du suivi)</li>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <ul className="list-disc list-inside space-y-2 ml-4">
                      <li><strong>Personnel autorisé de Songo Workout :</strong> Nos coachs et notre équipe administrative</li>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <div className="mt-6 p-4 bg-laboratory-100 rounded-lg">
                      ...
                      <p>Contactez-nous par email à : <a href="mailto:contact@songoworkout.fr" className="text-brand-400 hover:text-brand-500 underline">contact@songoworkout.fr</a></p>
                      <p className="mt-2">ou par courrier à :<br />
                      Songo Workout - Service Données Personnelles<br />
                      Paris, France</p>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    <p>
                      Songo Workout met en œuvre toutes les mesures techniques et organisationnelles appropriées pour garantir la sécurité de vos données :
                    </p>
                    <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    <p>
                      Songo Workout se réserve le droit de modifier cette politique de confidentialité à tout moment. Toute modification substantielle vous sera notifiée par email ou via un avertissement visible sur notre site.
                    </p>
                    <p>
