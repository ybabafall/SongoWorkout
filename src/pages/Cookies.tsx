            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mb-16">
                ...
                <p className="text-body-base text-neutral-700 max-w-3xl mx-auto leading-relaxed font-body">
                  Songo Workout utilise des cookies pour améliorer votre expérience de navigation et analyser l'utilisation de notre site.
                </p>
              </div>
              ...
              <div className="space-y-8">
                    ...
                    <div>
                      ...
                      <div className="bg-laboratory-100 rounded-lg p-4">
                        ...
                        <ul className="list-disc list-inside space-y-1 ml-4">
                          ...
                          <li>Cookies de panier : mémorisation des programmes sélectionnés</li>
                    ...
                    <div>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                        <p className="font-semibold text-green-900">
                          ✓ Songo Workout n'utilise actuellement AUCUN cookie publicitaire ou de réseaux sociaux.
                        </p>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <div className="mt-6 p-4 bg-laboratory-100 rounded-lg">
                      ...
                      <p>Contactez-nous à : <a href="mailto:contact@songoworkout.fr" className="text-brand-400 hover:text-brand-500 underline">contact@songoworkout.fr</a></p>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    <p>
                      Songo Workout se réserve le droit de modifier cette politique de cookies à tout moment. Toute modification sera portée à votre connaissance via notre bandeau de consentement ou par un avertissement visible sur notre site.
                    </p>
                    <p>
                ...
                >
                  ...
                  <div className="space-y-4 text-body-base text-neutral-900/80 font-body leading-relaxed">
                    ...
                    <div className="p-4 bg-laboratory-100 rounded-lg">
                      <p className="font-semibold text-neutral-900">Songo Workout</p>
                      <p className="mt-2">
                        Email : <a href="mailto:contact@songoworkout.fr" className="text-brand-400 hover:text-brand-500 underline">contact@songoworkout.fr</a><br />
